...
config.General.requestName = 'forest_PyquenFW_Z30mumuJet_Hydjet_MB'
...
config.Data.inputDataset = '/PyquenFW_Z30mumuJet_Hydjet_MB/HINPbPbWinter16DR-75X_mcRun2_HeavyIon_v13-v1/AODSIM'
