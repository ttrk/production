...
config.General.requestName = "Tier0_LowEGJet_Run306462_RECO_92X"
config.General.transferLogs = False

config.section_("JobType")
config.JobType.pluginName = "Analysis"
config.JobType.psetName = "Reco_9_2_14_patch1.py"
...
config.Data.outputDatasetTag = "LowEGJet_Run306462_RECO_92X"
