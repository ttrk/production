...
hltGetConfiguration /users/katatar/HI2017PPRef/HIHighPtRefPP5TeVPhoton/V2  --full --offline --mc --unprescale --process TEST  --l1-emulator FullMC --l1Xml L1Menu_Collisions2017_dev_r9_HIppRefMOD.xml  --globaltag 92X_upgrade2017_realistic_v11 --output none --max-events 10 --input root://cms-xrd-global.cern.ch//store/user/gsfs/Pythia8_Photon300_pp_CUETP8M1_5020GeV/RAW_20171002/171002_194612/0000/step2_pp_DIGI_L1_DIGI2RAW_HLT_1.root --setup /dev/CMSSW_9_2_0/GRun > hlt.py
