...
config.General.requestName = "run3_pp22_privateMC_QCDDijet15_pythia8_5p36TeV_FOREST_mAOD_userInput"
...
config.Data.outLFNDirBase = "/store/user/katatar/run3/run3_pp22_privateMC_QCDDijet15_pythia8_5p36TeV_FOREST_mAOD/"
