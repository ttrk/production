...
# with command line options: step3 -s RAW2DIGI,L1Reco,RECO --conditions auto:phase1_2022_realistic_hi --datatier GEN-SIM-RECO --eventcontent AODSIM --era Run3_pp_on_PbPb --nThreads 8 --filein file:step2_DIGI.root --fileout file:.//step3_RECO.root -n 50 --no_exec --python_filename step3_RECO.py
