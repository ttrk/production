...
config.General.requestName = "TTJets_TuneCP5_HydjetDrumMB_5p02TeV-amcatnloFXFX-pythia8_FOREST"
...
# Number of blocks: 18 Number of events: 2480372 Number of files: 889 Number of lumis: 2415 sum(file_size): 2923342502345 (2.9TB)
config.JobType.inputFiles = ["HeavyIonRPRcd_PbPb2018_offline.db"]

config.section_("Data")
config.Data.inputDataset = "/TTJets_TuneCP5_HydjetDrumMB_5p02TeV-amcatnloFXFX-pythia8/HINPbPbAutumn18DR-mva98_103X_upgrade2018_realistic_HI_v11-v1/AODSIM"
