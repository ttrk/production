...
config.General.requestName = "TT_TuneCP5_HydjetDrumMB_5p02TeV-powheg-pythia8_FOREST"
...
# Number of blocks: 8 Number of events: 1998000 Number of files: 694 Number of lumis: 1998 sum(file_size): 2350454951528 (2.4TB)
config.JobType.inputFiles = ["HeavyIonRPRcd_PbPb2018_offline.db"]

config.section_("Data")
config.Data.inputDataset = "/TT_TuneCP5_HydjetDrumMB_5p02TeV-powheg-pythia8/HINPbPbAutumn18DR-mva98_103X_upgrade2018_realistic_HI_v11-v1/AODSIM"
