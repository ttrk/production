...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        "/store/himc/HINPbPbAutumn18DR/QCD_pThat-50_EMEnrichedDijet_TuneCP5_HydjetDrumMB_5p02TeV_pythia8/AODSIM/mva98_103X_upgrade2018_realistic_HI_v11-v2/100000/103DA95C-391B-064A-87EE-EABCF91CB1A6.root"
        ),
    )
...
process.ggHiNtuplizer.doPfIso = cms.bool(True)
