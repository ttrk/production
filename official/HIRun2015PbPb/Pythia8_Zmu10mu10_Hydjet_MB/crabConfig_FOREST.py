...
config.General.requestName = 'forest_Pythia8_Zmu10mu10_Hydjet_MB'
...
config.Data.inputDataset = '/Pythia8_Zmu10mu10_Hydjet_MB/HINPbPbWinter16DR-75X_mcRun2_HeavyIon_v13_ext1-v1/AODSIM'
