...
#                                "file:step3_MinBias_pPb_RAW2DIGI_L1Reco_RECO_1.root"
                                "file:/afs/cern.ch/work/k/katatar/public/HIRun2016PA/CMSSW_8_0_15/src/Pythia8_Dijet15_pp_TuneCUETP8M1_8160GeV_EposLHC/step3_RAW2DIGI_L1Reco_RECO.root"
                            )
)
...
## 2016.10.20 : Add Rechit analyzer
...
process.rechitanalyzer.EBTreePtMin = cms.untracked.double(0)
process.rechitanalyzer.EETreePtMin = cms.untracked.double(0)
process.rechitanalyzer.HBHETreePtMin = cms.untracked.double(0)
process.rechitanalyzer.HFTreePtMin = cms.untracked.double(0)
## 2016.10.20 : Add Rechit analyzer - END

## 2016.10.20 : doTower
## 2016.10.20 : doTower - END
