...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:Pythia8_Dijet15_pp_TuneCUETP8M1_8160GeV_cff_py_GEN_SIM_PU.root'),
