...
# with command line options: step3 --mc --datatier GEN-SIM-RECO --conditions 80X_mcRun2_asymptotic_v17 -s RAW2DIGI,L1Reco,RECO --eventcontent RECOSIM --era Run2_2016 --customise RecoHI/Configuration/customise_PPwithHI.customisePPrecoforPPb --customise_commands process.bunchSpacingProducer.bunchSpacingOverride=cms.uint32(25)\nprocess.bunchSpacingProducer.overrideBunchSpacing=cms.bool(True) -n 10 --no_exec --filein=file:step2_DIGI_L1_DIGI2RAW_HLT_PU.root --fileout=file:step3_RAW2DIGI_L1Reco_RECO.root --python_filename=step3_RAW2DIGI_L1Reco_RECO.py
