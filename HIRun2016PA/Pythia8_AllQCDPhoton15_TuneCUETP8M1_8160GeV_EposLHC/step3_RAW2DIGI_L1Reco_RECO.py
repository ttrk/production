...
# with command line options: step3 --mc --datatier GEN-SIM-RECO --conditions 80X_mcRun2_asymptotic_v15 -s RAW2DIGI,L1Reco,RECO --eventcontent RECOSIM --era Run2_2016 --customise RecoHI/Configuration/customise_PPwithHI.customisePPrecoforPPb -n 10 --no_exec --filein=file:step2_DIGI_L1_DIGI2RAW_HLT_PU.root
