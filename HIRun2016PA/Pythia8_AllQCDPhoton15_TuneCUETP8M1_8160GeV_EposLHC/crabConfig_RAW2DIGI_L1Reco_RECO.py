...
config.General.requestName = "Pythia8_AllQCDPhoton15_TuneCUETP8M1_8160GeV_EposLHC_RAW2DIGI_L1Reco_RECO" # Defaults to <time-stamp>, where the time stamp is of the form <YYYYMMDD>_<hhmmss> and corresponds to the submission time. 
...
config.Data.outputDatasetTag = "Pythia8_AllQCDPhoton15_TuneCUETP8M1_8160GeV_EposLHC_RAW2DIGI_L1Reco_RECO"
