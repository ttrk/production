...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/hidata/XeXeRun2017/HIMinimumBias7/RAW/v1/000/304/899/00000/000AB151-8CAF-E711-A03A-02163E019BA4.root'),
...
process.GlobalTag = GlobalTag(process.GlobalTag, '100X_dataRun2_v1', '')
...
process.caloStage2Params.hiFlag = cms.uint32(1)
process.caloStage2Params.jetPUSType = cms.string('PhiRingPPTowerMedian')
