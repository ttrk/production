...
echo "process.caloStage2Params.egHOverEcutBarrel = cms.int32(0)" >> $config_l1Ntuple
echo "process.caloStage2Params.egHOverEcutEndcap = cms.int32(0)" >> $config_l1Ntuple
