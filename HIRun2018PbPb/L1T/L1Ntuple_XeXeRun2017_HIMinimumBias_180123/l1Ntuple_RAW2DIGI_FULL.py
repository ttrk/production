...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://xrootd.cmsaf.mit.edu//store/hidata/XeXeRun2017/HIMinimumBias8/RAW/v1/000/304/899/00000/02339E6D-94AF-E711-A9FC-02163E0122EE.root'),
...
process.L1TriggerRAW = cms.PSet(
    outputCommands = cms.untracked.vstring('keep  FEDRawDataCollection_rawDataRepacker_*_*', 
        'keep  FEDRawDataCollection_source_*_*')
)
...
process.fakeBmtfParams = cms.ESProducer("L1TMuonBarrelParamsESProducer",
    ...
    mask_ettf_st1 = cms.vstring('000000000000', 
        '000000000000', 
        '000000000000', 
        '000000000000', 
        '000000000000', 
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS'),
    globaltag = cms.string('94X_dataRun2_v2'),
...
process.totemDAQMappingESSourceXML_TimingDiamond = cms.ESSource("TotemDAQMappingESSourceXML",
    configuration = cms.VPSet(cms.PSet(
        ...
        cms.PSet(
            ...
            maskFileNames = cms.vstring(),
            validityRange = cms.EventRange(292521, 0, 1, 999999999, 0, 0)
        )),
...
process.RawToDigi_noTk = cms.Sequence(process.L1TRawToDigi+process.ecalDigis+process.ecalPreshowerDigis+process.hcalDigis+process.muonCSCDigis+process.muonDTDigis+process.muonRPCDigis+process.castorDigis+process.scalersRawToDigi+process.tcdsDigis+process.ctppsRawToDigi)
