...
# with command line options: step3 --runUnscheduled --conditions 103X_upgrade2018_realistic_HI_v6 --step RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO --eventcontent AODSIM --geometry DB:Extended --era Run2_2018_pp_on_AA,pf_badHcalMitigation --filein file:step2_DIGI_L1_DIGI2RAW_HLT_PU.root --fileout file:step3_RAW2DIGI_L1Reco_RECO.root -n 10 --no_exec --python_filename step3_RAW2DIGI_L1Reco_RECO.py
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

process = cms.Process('RECO',eras.Run2_2018_pp_on_AA,eras.pf_badHcalMitigation)
...
process.ak4PFJetsCHS.src = cms.InputTag('particleFlow')
process.ak8PFJetsCHS.src = cms.InputTag('particleFlow')
