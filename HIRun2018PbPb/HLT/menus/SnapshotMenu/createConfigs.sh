...
## Snapshot menu that went to JIRA ticket, contains the following
...
# no --setup and --unprescale for snapshot menu
hltGetConfiguration $menu --globaltag $GLOBALTAG --input $inputFile --process $PROCESS \
--full --offline $DATAMC $L1EMU $CUSTOMISE --l1Xml $L1XML \
