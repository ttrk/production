...
config.General.requestName = 'forest_Pythia8_Z30mumuJet'
...
config.Data.inputDataset = '/Pythia8_Z30mumuJet/HINppWinter16DR-75X_mcRun2_asymptotic_ppAt5TeV_v3_ext1-v1/AODSIM'
