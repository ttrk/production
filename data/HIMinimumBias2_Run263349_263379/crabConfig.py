...
# https://github.com/CmsHI/cmssw/commit/c32f0fc41c29226dc80cac56a4ef063f4ea4b2df
# relevant DAS query : file run between [263349, 263379] dataset=/HIMinimumBias2/HIRun2015-PromptReco-v1/AOD | sum(file.nevents)

config.section_('Data')
config.Data.inputDataset = '/HIMinimumBias2/HIRun2015-PromptReco-v1/AOD'
config.Data.inputDBS = 'global'
config.Data.lumiMask = '/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions15/HI/Cert_262548-263757_PromptReco_HICollisions15_JSON_v2.txt'
config.Data.runRange = '263349-263379'
config.Data.splitting = "FileBased"
config.Data.unitsPerJob = 1
config.Data.totalUnits = -1
config.Data.publication = False
config.Data.outputDatasetTag = 'HIRun2015-PromptReco-v1-Run263349-263379'
