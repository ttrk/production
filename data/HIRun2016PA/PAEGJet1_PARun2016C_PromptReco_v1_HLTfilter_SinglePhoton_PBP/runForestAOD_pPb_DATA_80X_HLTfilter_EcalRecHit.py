...
"file:root://cms-xrd-global.cern.ch//store/hidata/PARun2016C/PAEGJet1/AOD/PromptReco-v1/000/286/009/00000/32CA8C3A-A7B6-E611-962C-02163E014168.root"
				)
)
...
process.TFileService = cms.Service("TFileService",
                                   fileName=cms.string("HiForestAOD_HLTfilter.root"))
...
process.rechitanalyzer.EBTreePtMin = cms.untracked.double(1)
process.rechitanalyzer.EETreePtMin = cms.untracked.double(1)
...
#process.hltfilter.HLTPaths = ["HLT_PASinglePhoton30_Eta3p1_v*","HLT_PASinglePhoton40_Eta3p1_v*","HLT_PASinglePhoton30_L1EGJet_Eta3p1_v*","HLT_PASinglePhoton40_L1EGJet_Eta3p1_v*"]
process.hltfilter.HLTPaths = ["HLT_PASinglePhoton30*_Eta3p1_v*","HLT_PASinglePhoton40*_Eta3p1_v*"]
