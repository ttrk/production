...
config.General.requestName = 'PASingleMuon_PARun2016C_PromptReco_v1_ZMMfilter_PPB_FOREST'
...
config.Data.outputDatasetTag = 'PARun2016C_PromptReco_v1_ZMMfilter_PPB_FOREST'
