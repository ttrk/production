...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        "/store/data/Run2018D/SingleMuon/AOD/22Jan2019-v2/270000/F81740B2-0EB6-1A40-AE89-3D1CB6D722B6.root"
        ),
    )
...
process.ggHiNtuplizerGED.useValMapIso = False
...
## KT : fix vertex collection
process.ppTrack.vertexSrc = cms.VInputTag(cms.InputTag("offlinePrimaryVertices"))  # offlinePrimaryVerticesRecovery
## KT : fix vertex collection - END
