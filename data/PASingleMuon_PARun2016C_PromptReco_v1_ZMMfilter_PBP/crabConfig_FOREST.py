...
config.General.requestName = 'PASingleMuon_PARun2016C_PromptReco_v1_ZMMfilter_PBP_FOREST'
...
config.Data.outputDatasetTag = 'PARun2016C_PromptReco_v1_ZMMfilter_PBP_FOREST'
