...
# with command line options: step3 --datatier GEN-SIM-RECO --conditions auto:run2_mc_HIon --scenario HeavyIons -s RAW2DIGI,L1Reco,RECO --eventcontent RECOSIM -n 5 --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI --filein file:step2_SingleGammaFlatPt10To200_pythia8_HI.root --fileout file:step3_SingleGammaFlatPt10To200_pythia8_HI.root --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step2_SingleGammaFlatPt10To200_pythia8_HI.root'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_SingleGammaFlatPt10To200_pythia8_HI.root'),
