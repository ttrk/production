...
#### General ####
config.General.requestName = "RelValZEEMM_13_HI_FOREST" # Defaults to <time-stamp>, where the time stamp is of the form <YYYYMMDD>_<hhmmss> and corresponds to the submission time. 
...
#### Data ####
config.Data.inputDataset = "/RelValZEEMM_13_HI/katatar-RelValZEEMM_13_HI_753p1-8464e7c32dba41b93ae62574ea53b62c/USER"
...
config.Data.publishDataName = "RelValZEEMM_13_HI_753p1_FOREST"  # put CMSSW release
