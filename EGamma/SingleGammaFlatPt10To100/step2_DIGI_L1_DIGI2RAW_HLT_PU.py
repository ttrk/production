...
# with command line options: step2 --mc --eventcontent RAWSIM --pileup HiMixNoPU --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI --datatier GEN-SIM-RAW --conditions 75X_mcRun2_HeavyIon_v14 --step DIGI:pdigi_hi,L1,DIGI2RAW,HLT:HIon --scenario HeavyIons -n 10 --no_exec --filein file:SingleGammaFlatPt10To100_pythia8_GEN_SIM.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:SingleGammaFlatPt10To100_pythia8_GEN_SIM.root'),
