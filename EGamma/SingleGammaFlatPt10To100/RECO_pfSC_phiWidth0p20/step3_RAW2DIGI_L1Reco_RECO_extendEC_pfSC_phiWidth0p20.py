...
# with command line options: step3 --mc --eventcontent AODSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI --datatier AODSIM --conditions 75X_mcRun2_HeavyIon_v14 --step RAW2DIGI,L1Reco,RECO --scenario HeavyIons -n 10 --no_exec --filein file:step2_DIGI_L1_DIGI2RAW_HLT_PU.root
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_extendEC.root'),
