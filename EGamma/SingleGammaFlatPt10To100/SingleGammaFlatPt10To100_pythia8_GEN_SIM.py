...
# with command line options: Configuration/GenProduction/python/SingleGammaFlatPt10To100_pythia8_cfi.py --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI --datatier GEN-SIM --conditions 75X_mcRun2_HeavyIon_v14 --beamspot NominalHICollision2015 --step GEN,SIM --scenario HeavyIons -n 20 --no_exec --python_filename SingleGammaFlatPt10To100_pythia8_GEN_SIM.py --fileout SingleGammaFlatPt10To100_pythia8_GEN_SIM.root
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SingleGammaFlatPt10To100_pythia8_GEN_SIM.root'),
