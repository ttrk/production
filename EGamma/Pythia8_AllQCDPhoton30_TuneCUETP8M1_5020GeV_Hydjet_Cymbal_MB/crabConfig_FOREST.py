...
config.JobType.psetName = "runForestAOD_PbPb_MIX_75X_rechit.py"
...
# use the the following version of RecHitTreeProducer.cc
# https://github.com/CmsHI/cmssw/blob/2a6ebbd1e107927de1c284d6da397213809d644f/HeavyIonsAnalysis/JetAnalysis/src/RecHitTreeProducer.cc
