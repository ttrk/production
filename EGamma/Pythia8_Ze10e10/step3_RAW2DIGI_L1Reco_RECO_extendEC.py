...
# with command line options: step3 --mc --eventcontent AODSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --datatier AODSIM --conditions 75X_mcRun2_asymptotic_ppAt5TeV_v3 --step RAW2DIGI,L1Reco,RECO -n 10 --no_exec --filein file:step2_DIGI_L1_DIGI2RAW_HLT_PU.root
