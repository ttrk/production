...
config.General.requestName = "SingleGammaFlatPt10To200_pythia8_Hydjet_GEN_SIM_PU" # Defaults to <time-stamp>, where the time stamp is of the form <YYYYMMDD>_<hhmmss> and corresponds to the submission time. 
config.General.transferLogs = True

config.section_("JobType")
config.JobType.pluginName = "PrivateMC"
config.JobType.psetName = "SingleGammaFlatPt10To200_pythia8_Hydjet_GEN_SIM_PU.py"
...
config.Data.outputDatasetTag = "SingleGammaFlatPt10To200_pythia8_Hydjet_GEN_SIM_PU"
