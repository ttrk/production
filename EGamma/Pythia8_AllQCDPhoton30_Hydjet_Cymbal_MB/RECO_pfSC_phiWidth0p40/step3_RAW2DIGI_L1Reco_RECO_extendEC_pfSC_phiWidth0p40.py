...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_extendEC_pfSC_phiWidth0p40.root'),
...
process.particleFlowSuperClusterECAL.phiwidth_SuperClusterBarrel = cms.double(0.40)
process.particleFlowSuperClusterECAL.phiwidth_SuperClusterEndcap = cms.double(0.40)
