...
# with command line options: step2 --mc --eventcontent RAWSIM --pileup HiMixNoPU --datatier GEN-SIM-RAW --conditions 103X_upgrade2018_realistic_HI_v7 --step DIGI:pdigi_hi,L1,DIGI2RAW,HLT:@fake2 --geometry DB:Extended --era Run2_2018_pp_on_AA --filein file:step_GEN_SIM.root --fileout file:step2_DIGI_L1_DIGI2RAW_HLT_PU.root -n 50 --no_exec --python_filename step2_DIGI_L1_DIGI2RAW_HLT_PU.py
