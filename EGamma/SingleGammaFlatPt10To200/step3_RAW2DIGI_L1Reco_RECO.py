...
# with command line options: step3 --mc --eventcontent RECOSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI --datatier GEN-SIM-RECO --conditions 75X_mcRun2_HeavyIon_v13 --step RAW2DIGI,L1Reco,RECO --scenario HeavyIons -n 50 --no_exec --filein file:step2_DIGI_L1_DIGI2RAW_HLT_PU.root
